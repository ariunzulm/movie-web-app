...
const Navigation = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border border-b-zinc-200">
          ...
          {isSearchOpen && (hasResult || showNoResults) && (
            <div className="absolute top-full mt-2 flex-col w-110 flex gap-1 bg-zinc-200 backdrop-blur-lg shadow-2xl rounded-2xl">
              {hasResult ? (
                ...
                <div className="absolute top-full mt-2 flex items-center justify-center w-110 h-23.75 bg-zinc-200 backdrop-blur-lg shadow-2xl rounded-2xl">
